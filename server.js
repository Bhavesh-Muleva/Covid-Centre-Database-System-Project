...
var db = mongoose.connect('mongodb+srv://anand:anand@cluster0.zkdtf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true }, () => {
...
const store = new MongoSession({
    uri: "mongodb+srv://anand:anand@cluster0.zkdtf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
    collection: "Session"
})
...
var adminmod = mongoose.model("Admin", adminschema)
    // var admin1 = new adminmod({ useremail: "anand@123", password: "anand" })
    // admin1.save().then(() => {
    //     console.log("added")
    // }).catch(() => {
    //     console.log("not")
